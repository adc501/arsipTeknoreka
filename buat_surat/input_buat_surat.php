...
?>
  ...
  <section class="home-section">
    <div class="text px-4">Input Data Buat Surat</div>
      <div class="content px-4">
        <div class="card">
            <div class="card-body">
            <?php
            include $_SERVER['DOCUMENT_ROOT']."/tes4/koneksi.php";
            include_once $_SERVER['DOCUMENT_ROOT'].'/tes3/fungsi/fungsi_romawi.php';
            $q = mysqli_query($koneksi, "SELECT * FROM buat");
            $bil = 1;
            ...
            <form method="post" action="action/buat_surat_action.php" enctype="multipart/form-data" class="row g-3 px-4">
                <div class="col-md-6">
                    <label class="form-label">Kode Surat <span class="text-danger">*</span></label><br />
                    <input id="inputCodSurat" type="text" class="form-control" name="kode_surat" required="required" value="<?php echo $no ?>" readonly>
                    <input type="hidden" id="codSurat" value="<?php echo $no ?>" readonly>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="lampiran" required="required">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Hal <span class="text-danger">*</span></label><br />
                    <input type="text" class="form-control" name="hal" required="required">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="isi" placeholder="Tulis Surat Disini" id="floatingTextarea" rows="10"></textarea>
                </div>
                <div class="col-12">
                    <label class="form-label">Penutup Surat <span class="text-danger">*</span></label><br />
                    <textarea class="form-control" name="penutup" placeholder="Tulis Surat Disini" id="floatingTextarea" rows="10"></textarea>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Identitas <span class="text-danger">* (Jabatan)</span></label><br />
                    <input type="text" class="form-control" name="identitas" required="required">
                </div>
                <div class="col-md-4">
