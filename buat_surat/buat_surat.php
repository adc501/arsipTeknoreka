  ...
  <section class="home-section">
        ...
        <div class="content">
            <form class="row g-3 px-4" method="POST" action="">
                ...
                <a href="input_buat_surat.php" type="button" class="btn btn-danger"><i class='bx bx-plus'><span>Tambah</span></i></a>
                </div>
            </form>
            <hr>
            <div class="row px-4">
                    <table class="table table-striped">
                        ...
                        <?php
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $result_count = mysqli_query($koneksi, "SELECT COUNT(*) AS ttl_records FROM buat");
                                ...
                                $query = mysqli_query($koneksi, "SELECT * FROM buat WHERE jenis_surat='$jenis_surat' AND date(`tanggal_masuk`) BETWEEN '$date1' AND '$date2' OR jenis_surat='$jenis_surat' OR date(`tanggal_masuk`) BETWEEN '$date1' AND '$date2' LIMIT $offset, $ttl_records_per_page") or die("gagal");
                                ...
                                if ($row > 0) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_buat_surat.php?kode_surat=<?php echo $fetch['kode_surat']; ?>"><i class='bx bx-edit'></i></a>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#hapusmodal<?php echo $fetch['kode_surat'] ?>"><i class='bx bx-trash'></i></a>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#modalscan<?php echo $fetch['kode_surat'] ?>"><i class='bx bx-scan'></i></a>
                                                <a href="action/pdf.php?kode_surat=<?php echo $fetch['kode_surat'];?>"><i class='bx bx-printer'></i></a>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <button type="button" class="btn btn-danger"><a href="action/hapus_buat_action.php?kode_surat=<?php echo $fetch['kode_surat']; ?>" style="text-decoration: none; color:#FFF;">Hapus</a></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal fade" id="modalscan<?php echo $fetch['kode_surat'] ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Isi Data Disini</h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="post" action="action/scan_action.php" enctype="multipart/form-data">
                                                            <div class="mb-3">
                                                                <label class="form-label">Kode Surat <span class="text-danger">*</span></label><br />
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">File Scan <span class="text-danger">* (pdf, docx, doc)</span></label><br />
                                ...
                                $query = mysqli_query($koneksi, "SELECT * FROM buat LIMIT $offset, $ttl_records_per_page") or die("gagal");
                                while ($fetch = mysqli_fetch_array($query)) {
                                    ?>
                                    <tr>
                                        <td><?php echo $fetch['kode_surat'] ?></td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="action/scan_action.php" enctype="multipart/form-data">
                                                        <div class="mb-3">
                                                            <label class="form-label">Kode Surat <span class="text-danger">*</span></label><br />
                                                            <input id="inputCodSurat" type="text" class="form-control" name="kode_surat" required="required" value="<?php echo $fetch['kode_surat'] ?>" readonly>                                                        
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">File Scan <span class="text-danger">* (.png, .jpg, .jpeg)</span></label><br />
                                                            <input type="file" class="form-control" name="scan" required>
                                                        </div>
                                                        <input type="submit" class="btn btn-primary" value="Simpan">
                                                    </form>
