...
?>
  ...
  <section class="home-section">
    <div class="text px-4">Input Data Surat Keluar</div>
      <div class="content px-4">
        <div class="card">
            <div class="card-body">
                ...
                <form id="signatureform" action="action/surat_keluar_action.php" method="post" enctype="multipart/form-data">
                    <div class="row g-3 px-4">
                        <div class="col-md-6">
                            <label class="form-laber">Jenis Surat <span class="text-danger">*</span></label><br>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" class="form-control" name="cop_surat" required="required">
                        </div>
